...
namespace Gherkin3
{
    ...
    public class GherkinDialectProvider : IGherkinDialectProvider
    {
        ...
        {
            get { return this.defaultDialect.Value; }
        }

        public GherkinDialectProvider(string defaultLanguage = "en")
        {
            this.defaultDialect = new Lazy<GherkinDialect>(() => this.GetDialect(defaultLanguage, null));
        }

        public virtual GherkinDialect GetDialect(string language, Location location)
        {
            var gherkinLanguageSettings = this.LoadLanguageSettings();
            return this.GetDialect(language, gherkinLanguageSettings, location);
        }
        ...
        protected virtual Dictionary<string, GherkinLanguageSetting> LoadLanguageSettings()
        {
            ...
            return this.ParseJsonContent(languagesFileContent);
        }
        ...
        protected virtual GherkinDialect GetDialect(string language, Dictionary<string, GherkinLanguageSetting> gherkinLanguageSettings, Location location)
        {
            ...
            return this.CreateGherkinDialect(language, languageSettings);
        }
        ...
        protected GherkinDialect CreateGherkinDialect(string language, GherkinLanguageSetting languageSettings)
        {
            return new GherkinDialect(
                language,
                this.ParseTitleKeywords(languageSettings.feature),
                this.ParseTitleKeywords(languageSettings.background),
                this.ParseTitleKeywords(languageSettings.scenario),
                this.ParseTitleKeywords(languageSettings.scenarioOutline),
                this.ParseTitleKeywords(languageSettings.examples),
                this.ParseStepKeywords(languageSettings.given),
                this.ParseStepKeywords(languageSettings.when),
                this.ParseStepKeywords(languageSettings.then),
                this.ParseStepKeywords(languageSettings.and),
                this.ParseStepKeywords(languageSettings.but)
            );
        }
