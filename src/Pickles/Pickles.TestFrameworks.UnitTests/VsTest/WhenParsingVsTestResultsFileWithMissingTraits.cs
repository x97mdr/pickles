//  --------------------------------------------------------------------------------------------------------------------
//  <copyright file="WhenParsingVsTestResultsFileWithMissingTraits.cs" company="PicklesDoc">
...
{
    [TestFixture]
    public class WhenParsingVsTestResultsFileWithMissingTraits : WhenParsingTestResultFiles<VsTestResults>
    {
        public WhenParsingVsTestResultsFileWithMissingTraits()
            : base("VsTest." + "results-example-vstest-missingTraits.trx")
        {
        }
