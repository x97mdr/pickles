//  --------------------------------------------------------------------------------------------------------------------
//  <copyright file="WhenParsingVsTestResultsFileWithIndividualResults.cs" company="PicklesDoc">
...
{
    [TestFixture]
    public class WhenParsingVsTestResultsFileWithIndividualResults : StandardTestSuiteForScenarioOutlines<VsTestResults>
    {
