...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Line endings in the description should be preserved in generated HTML")]
        public virtual void LineEndingsInTheDescriptionShouldBePreservedInGeneratedHTML()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Line endings in the description should be preserved in generated HTML", ((string[])(null)));
#line 163
this.ScenarioSetup(scenarioInfo);
#line hidden
#line 165
  testRunner.Given("I have this feature description", "In order to see the description as nice HTML\r\nAs a Pickles user\r\nI want to preser" +
                    "ve the line endings in my description\r\n\r\nso the HTML reads the same as the featu" +
                    "re file", ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 173
  testRunner.When("I generate the documentation", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 174
